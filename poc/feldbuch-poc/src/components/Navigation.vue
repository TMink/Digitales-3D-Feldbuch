<template>
    <div id="navbar">
        <v-row justify="center">
          ...
          <v-card class="ma-2" color="#BC987D" v-on:click="toSections" dark :disabled="!projectIsSet">
            <v-card-title class="justify-center"> Schnitte </v-card-title>
          </v-card>

          <v-card class="ma-2" color="#BC987D" v-on:click="toFeatures" dark :disabled="!projectIsSet">
            <v-card-title class="justify-center"> Befunde </v-card-title>
          </v-card>

          <v-card class="ma-2" color="#BC987D" v-on:click="toArtifacts" dark :disabled="!projectIsSet">
            <v-card-title class="justify-center"> Funde </v-card-title>
          </v-card>

          <v-card class="ma-2" color="#BC987D" v-on:click="toSamples" dark :disabled="!projectIsSet">
