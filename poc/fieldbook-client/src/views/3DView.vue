  ...
  <v-navigation-drawer id="navDrawer" 
    ...
    <v-list>
      ...
      <v-list-group>
        ...
        <v-checkbox-btn v-model="gizmoState"
          label="Gizmo"
          class="pl-16"
        ...
        <v-list-group>
          ...
          <div v-if="showDrawerContent">
            ...
            <v-list-group 
              ...
              <!-- Color Picker -->
              <v-color-picker v-model="colors[i]"
                hide-inputs 
          ...
          <v-list-group
            ...
            <div v-if="showDrawerContent">
              ...
              <v-radio 
                ...
                :value="placeModelsInScene.length + 1 + i"
                v-on:click="attachTransformControls(i)">
              </v-radio>

              <!-- Color Picker -->
              <v-color-picker v-model="colors[placeModelsInScene.length + i]"
                hide-inputs 
                :v-on:change="changeColor(colors[placeModelsInScene.length + i],
                              position.modelID)">
              </v-color-picker>
            </div>
          </v-list-group>
